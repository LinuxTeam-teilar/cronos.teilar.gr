...
class UserProfile(models.Model):
    ...
    dionysos_password = models.CharField(max_length = 50)
    eclass_username = models.CharField(max_length = 30, null = True, blank = True)
    eclass_password = models.CharField(max_length = 50, null = True, blank = True)
    ...
    webmail_password = models.CharField(max_length = 50, null = True, blank = True)
